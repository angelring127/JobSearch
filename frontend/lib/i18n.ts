...
const en: Record<MessageKey, string> = {
  ...
  region: 'Region', regionUnavailable: 'Region unavailable', distance: 'Distance', postedDate: 'Posted', coordinates: 'Coordinates',
...
const ja: Record<MessageKey, string> = {
  ...
  distance: '距離', postedDate: '掲載日', coordinates: '座標', sourceSite: '掲載元', sourceLink: '元の求人を見る',
...
const zh: Record<MessageKey, string> = {
  ...
  region: '地区', regionUnavailable: '暂无地区信息', distance: '距离', postedDate: '发布日期', coordinates: '坐标',
